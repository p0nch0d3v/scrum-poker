...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Scrum Poker.
...
- __Website__ refers to Scrum Poker, accessible from [https://scrum-poker.chiripa.dev/](https://scrum-poker.chiripa.dev/)
...
If You decide to register through or otherwise grant us access to a Third-Party Social Media Service, We may collect Personal data that is already associated with Your Third-Party Social Media Service's account, such as Your name, Your email address.
...
- By visiting this page on our website: [https://scrum-poker.chiripa.dev/contact](https://scrum-poker.chiripa.dev/contact)
